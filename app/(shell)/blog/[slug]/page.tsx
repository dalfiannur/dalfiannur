...
export default function Page() {
  return (
    <div>
      <div className="bg-gray-300 h-[calc(100vh-396px)]" />
      <div>
        <div className="container mx-auto">
          <div className="grid grid-cols-3 gap-16">
            <div className="col-span-2 pr-20 border-r py-10">
              <div className="pb-10 border-b">
                <h2 className="font-baloo font-bold text-2xl">Introduction</h2>
              ...
              <div className="mt-10 flex flex-col gap-10">
                <div>
                  <h3 className="font-baloo font-bold text-3xl">
            ...
            <div className="py-10">
              <div className="grid grid-rows-2 grid-flow-col gap-x-4 gap-y-8 font-fredoka">
                <div className="mt-2 flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-0">
                  ...
                  <div className="font-fredoka">Author</div>
                ...
                <div className="mt-2 flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-0">
                  ...
                  <div className="font-fredoka">Publication Date</div>
                  <div className="font-fredoka font-semibold">20, Oct 2024</div>
                </div>
                ...
                <div className="mt-2 flex flex-row md:flex-col items-center md:items-start gap-4 md:gap-0">
                  ...
                  <div className="font-fredoka">Tags</div>
                  <ul className="flex flex-wrap items-center gap-4 font-fredoka font-semibold">
                    <li>#Javascript</li>
                    <li>#React</li>
                    <li>#Tailwind</li>
                  </ul>
              ...
              <div className="mt-16">
                <h3 className="font-baloo font-bold text-xl text-center">
                  Table of Contents
                </h3>
                <ul className="mt-4 bg-gray-100 border rounded-2xl p-8 list-disc list-inside">
                  <li>Introduction</li>

      ...
      <div className="py-20 relative overflow-hidden">
        ...
        <div className="relative z-1 container mx-auto">
          <div ref={ref} className="flex flex-col items-center">
            ...
            >
              <h2 className="text-4xl text-center font-bold font-baloo text-accent">
                My Expertise
              </h2>
            </motion.div>
            <motion.div
            ...
            >
              <p className="mt-4 text-xl text-center font-fredoka max-w-6xl text-subtle">
          ...
          <div className="mt-16 flex gap-16">
            <ul className="flex-1 flex flex-col gap-4 font-baloo">
              {data.map((item, index) => (
                ...
                >
                  <div className="border-b border-mute text-subtle hover:text-highlight">
                    <button
                    ...
                    >
                      <Image
                        ...
                        className="w-8 h-8"
                      />
                      <h3 className="group-data-[selected=true]:text-accent font-bold text-xl">
                        {item.title}
                      </h3>
                    </button>
                  </div>

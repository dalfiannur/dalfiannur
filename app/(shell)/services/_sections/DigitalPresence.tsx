        ...
        <div className="py-20">
          ...
          <div className="mt-4 text-subtle">
            <p className="font-fredoka text-center">
              My services open the door to a vibrant digital world. From
              engaging designs to flawless development and optimization, we’re
              here to make your digital dreams a reality.
            </p>
            <p className="font-fredoka text-center">
              ...
              >
                ...
                <div className="mt-8">
                  <Accordion label="Key Features">
                    <div className="flex">
                      <div className="w-min">
                        {getFeatures(service.features).titles.map(
                          (title, key) => (
                            <div
                              key={key}
                      ...
                      <div className="flex-1">
                        {getFeatures(service.features).descriptions.map(
                          (description, key) => (
                            <div
                              key={key}
